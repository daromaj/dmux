...
export const ACTION_REGISTRY: Record<PaneAction, ActionMetadata> = {
  ...
  [PaneAction.SET_PANE_COLOR]: {
    id: PaneAction.SET_PANE_COLOR,
    label: 'Set Pane Color',
    description: 'Assign a color to this pane for visual distinction',
    icon: '🎨',
  },
  [PaneAction.SET_AGENT]: {
    id: PaneAction.SET_AGENT,
    label: 'Change Agent',
    description: 'Relaunch this pane with a different agent',
    icon: '🔀',
    requires: { agent: true },
  },
  [PaneAction.MOVE_PANE_UP]: {
    id: PaneAction.MOVE_PANE_UP,
    label: 'Move Up',
    description: 'Swap this pane with the one above it',
    icon: '↑',
  },
  [PaneAction.MOVE_PANE_DOWN]: {
    id: PaneAction.MOVE_PANE_DOWN,
    label: 'Move Down',
    description: 'Swap this pane with the one below it',
    icon: '↓',
  },
