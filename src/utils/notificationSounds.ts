...
export const NOTIFICATION_SOUND_DEFINITIONS: readonly NotificationSoundDefinition[] = [
  ...
  },
  {
    id: 'braam',
    label: 'Braam',
    resourceFileName: 'qmux-braam.caf',
    defaultEnabled: false,
  },
  {
    id: 'brass',
    label: 'Brass',
    resourceFileName: 'qmux-brass.caf',
    defaultEnabled: false,
  },
  {
    id: 'ding-bell',
    label: 'Ding Bell',
    resourceFileName: 'qmux-ding-bell.caf',
    defaultEnabled: false,
  },
  {
    id: 'future',
    label: 'Future',
    resourceFileName: 'qmux-future.caf',
    defaultEnabled: false,
  },
  {
    id: 'harp',
    label: 'Harp',
    resourceFileName: 'qmux-harp.caf',
    defaultEnabled: false,
  },
  {
    id: 'quiet-bells',
    label: 'Quiet Bells',
    resourceFileName: 'qmux-quiet-bells.caf',
    defaultEnabled: false,
  },
  {
    id: 'sonar',
    label: 'Sonar',
    resourceFileName: 'qmux-sonar.caf',
    defaultEnabled: false,
  },
  {
    id: 'success',
    label: 'Success',
    resourceFileName: 'qmux-success.caf',
    defaultEnabled: false,
  },
  {
    id: 'triumphant-trumpet',
    label: 'Triumphant Trumpet',
    resourceFileName: 'qmux-triumphant-trumpet.caf',
    defaultEnabled: false,
  },
  {
    id: 'war-horn',
    label: 'War Horn',
    resourceFileName: 'qmux-war-horn.caf',
    defaultEnabled: false,
  },
] as const;
