...
export function render() {
  return `
    ...
    <div class="video-wrap">
      <video class="qmux-video" id="qmux-video" autoplay loop muted playsinline>
        <source src="/qmux.mp4" type="video/mp4" />
      </video>
      <button class="video-fullscreen" onclick="document.getElementById('qmux-video').requestFullscreen()" title="Fullscreen">
    ...
    <div class="sa-banner">
      <div class="sa-banner-inner">
        <div class="sa-banner-content">
          ...
          <p class="sa-description">From the team behind <a href="https://formkit.com" target="_blank" rel="noopener">FormKit</a>, <a href="https://tempo.formkit.com" target="_blank" rel="noopener">Tempo</a>, qmux, <a href="https://auto-animate.formkit.com" target="_blank" rel="noopener">AutoAnimate</a>, and <a href="https://drag-and-drop.formkit.com" target="_blank" rel="noopener">Drag and Drop</a> &mdash; Standard Agents is an open standard for creating domain-specific agents you can distribute and compose together to form safe, efficient, and effective agents. Join the early access waitlist below.</p>
